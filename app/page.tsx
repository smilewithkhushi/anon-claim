...
import { TechLogProvider } from '@/components/TechLogContext'
      ...
      <main className="min-h-screen px-4 py-16">
        <div className="mx-auto max-w-5xl">
          <div className="lg:flex lg:gap-10 lg:items-start lg:justify-center">
            ...
            {/* Right column — tech trace panel */}
            <div className="mt-8 lg:mt-0 lg:sticky lg:top-8 w-full lg:w-80 shrink-0">
              <TechLog />
            </div>
